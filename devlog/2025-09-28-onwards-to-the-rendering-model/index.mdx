...
description: "First abstractions for rendering - Vertex, Mesh, Material, and Shader separation of concerns"
tags: [devlog, helios]
keywords: [cpp, rendering, opengl, vertex, mesh, material, shader, learnopengl, modules, move semantics]
