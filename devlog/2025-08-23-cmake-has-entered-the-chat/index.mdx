...
description: "Benchmarking mat4 and vec3, switching to CLion and CMake, and comparing helios performance with GLM"
tags: [devlog, helios]
keywords: [cpp, cmake, benchmarking, google benchmark, clion, glm, mat4, vec3, performance, tooling]
