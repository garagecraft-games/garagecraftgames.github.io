...
description: "Refactoring the main loop - OpenGLDevice, GLFWApplication, and the first tick() implementation"
tags: [devlog, helios]
keywords: [cpp, game loop, tick, delta time, opengl, glfw, main loop, input manager, architecture]
